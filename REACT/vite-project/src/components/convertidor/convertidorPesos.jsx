...
export function ConvertidorMonedas() {
  ...
  useEffect(() => {
    fetch(
      "https://v6.exchangerate-api.com/v6/ed02ae7df8735c8dd83e37ec/latest/USD"
    )
        ...
        <div>
          <div className="select-container">
            <select
              className="select"
              value={monedaInicial}
              onChange={(e) => cambiarMonedaInicial(e.target.value)}
            >
            ...
            <button className="invert-button" onClick={invertirMonedas}>
              ↔️
            </button>
            <select
              className="select"
